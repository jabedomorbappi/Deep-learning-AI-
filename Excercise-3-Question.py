...
def train_mnist_conv():
    ...
    model = tf.keras.models.Sequential([
        ...
        #1st convolution 
        tf.keras.layers.Conv2D(filters=64,kernel_size=(3,3),strides=(1,1),padding='valid',activation='relu',input_shape=(28,28,1)),
        #1st maxpooling 
        ...
        # now converted 1 dimensional data 
        tf.keras.layers.Dense(128,activation='relu'),
        
        # output layer or dense to output 
